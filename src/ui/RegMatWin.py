...
class Ui_RegMatWin(object):
    def setupUi(self, RegMatWin):
        ...
        RegMatWin.resize(400, 240)
        RegMatWin.setMinimumSize(QtCore.QSize(400, 240))
        RegMatWin.setMaximumSize(QtCore.QSize(400, 240))
        ...
        self.table_regMat.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.table_regMat.setColumnCount(4)
        self.table_regMat.setObjectName("table_regMat")
        self.table_regMat.setRowCount(3)
        ...
        self.table_regMat.horizontalHeader().setVisible(True)
        self.table_regMat.horizontalHeader().setCascadingSectionResizes(False)
        self.table_regMat.horizontalHeader().setDefaultSectionSize(90)
        self.table_regMat.horizontalHeader().setMinimumSectionSize(10)
        self.table_regMat.horizontalHeader().setStretchLastSection(True)
        self.table_regMat.verticalHeader().setVisible(False)
        self.table_regMat.verticalHeader().setCascadingSectionResizes(True)
        self.table_regMat.verticalHeader().setDefaultSectionSize(50)
        self.table_regMat.verticalHeader().setMinimumSectionSize(10)
        self.table_regMat.verticalHeader().setStretchLastSection(True)
    ...
    def retranslateUi(self, RegMatWin):
        ...
        item = self.table_regMat.horizontalHeaderItem(0)
        item.setText(_translate("RegMatWin", "R1"))
        item = self.table_regMat.horizontalHeaderItem(1)
        item.setText(_translate("RegMatWin", "R2"))
        item = self.table_regMat.horizontalHeaderItem(2)
        item.setText(_translate("RegMatWin", "R3"))
        item = self.table_regMat.horizontalHeaderItem(3)
        item.setText(_translate("RegMatWin", "T"))
